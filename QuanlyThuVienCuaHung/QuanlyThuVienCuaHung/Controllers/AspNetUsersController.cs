...
namespace QuanlyThuVienCuaHung.Controllers
{
    ...
    public class AspNetUsersController : Controller
    {
        ...
        {
            var aspNetUsers = db.AspNetUsers.Include(a => a.LOAI_DOCGIA);
        ...
        public ActionResult Create([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,MaLoaiDG,HoTen,NgaySinh,DiaChi,NgayLapThe,TienNo,HanThe")] AspNetUser aspNetUser)
        {
